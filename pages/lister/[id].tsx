        ...
        <div className="flex justify-between my-10 ">
          <Card className="w-1/2">
            ...
            <p className="font-normal text-gray-700 dark:text-gray-400">
              Occaecat consectetur proident tempor cupidatat proident sint ipsum
              elit ad dolor ad id commodo. Ad cillum id proident reprehenderit
              et veniam. Sit ut quis est cupidatat exercitation eiusmod dolor
              magna ad est id est mollit. Nostrud sint labore incididunt id
              dolor non.
            </p>
            <Button>
              Start nå
            ...
            <div className="max-w-sm min-w-full w-full ">
             {
              typeof currentModalContent === "object" ? (
                ...
                <p className="font-normal tracking-widest text-gray-700 dark:text-gray-400">
                  {currentModalContent?.Chinese.split("").map((letter: string, index: number) => {
                    return (
                      <span key={index} className="inline-block m-2 hover:underline hover:text-blue-600">
                        {letter}
                      </span>
                    );
                  })}
